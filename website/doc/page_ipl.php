...
<P>Version 1.0 </P>
<P><I><B>1. Definitions. </B></I></P>
<P>1.0.1. &quot;<B><U>Commercial Use</U></B>&quot; means distribution or
otherwise making the Covered Code available to a third party. </P>
<P>1.1. ''<B><U>Contributor</U></B>'' means each entity that creates or
contributes to the creation of Modifications. </P>
<P>1.2. ''<B><U>Contributor Version'' </U></B>means the combination of the
Original Code, prior Modifications used by a Contributor, and the Modifications
made by that particular Contributor. </P>
<P>1.3. ''<B><U>Covered Code</U></B>'' means the Original Code or Modifications
or the combination of the Original Code and Modifications, in each case
including portions thereof. </P>
<P>1.4. ''<B><U>Electronic Distribution Mechanism</U></B>'' means a mechanism
generally accepted in the software development community for the electronic
transfer of data. </P>
<P>1.5. ''<B><U>Executable</U></B>'' means Covered Code in any form other than
Source Code. </P>
<P>1.6. ''<B><U>Initial Developer</U></B>'' means the individual or entity
identified as the Initial Developer in the Source Code notice required by
Exhibit A. </P>
<P>1.7. ''<B><U>Larger Work</U></B>'' means a work which combines Covered Code
or portions thereof with code not governed by the terms of this License. </P>
<P>1.8. ''<B><U>License</U></B>'' means this document. </P>
<P>1.8.1. &quot;<B><U>Licensable</U></B>&quot; means having the right to grant,
to the maximum extent possible, whether at the time of the initial grant or
subsequently acquired, any and all of the rights conveyed herein. </P>
<P>1.9. ''<B><U>Modifications</U></B>'' means any addition to or deletion from
the substance or structure of either the Original Code or any previous
Modifications. When Covered Code is released as a series of files, a
Modification is: </P>
<P>A. Any addition to or deletion from the contents of a file containing
Original Code or previous Modifications. </P>
<P>B. Any new file that contains any part of the Original Code or previous
Modifications. </P>
<P>1.10. ''<B><U>Original Code</U></B>'' means Source Code of computer software
...
<P>1.10.1. &quot;<B><U>Patent Claims</U></B>&quot; means any patent claim(s),
...
<P>1.11. ''<B><U>Source Code</U></B>'' means the preferred form of the Covered
...
<P>1.12. &quot;<B><U>You</U></B>'' (or &quot;<B><U>Your</U></B>&quot;) means an
...
shares or beneficial ownership of such entity.</P>
<P><B><I>2. Source Code License. </I></B></P>
<P>2.1. <B><U>The Initial Developer Grant. </U></B></P>
...
<P>(b) under Patents Claims infringed by the making, using or selling of
...
<P>(c) the licenses granted in this Section 2.1(a) and (b) are effective on the
date Initial Developer first distributes Original Code under the terms of this
License. </P>
<P>(d) Notwithstanding Section 2.1(b) above, no patent license is granted: 1)
...
devices. </P>
<P>2.2. <B><U>Contributor Grant. </U></B></P>
<P>Subject to third party intellectual property claims, each Contributor hereby
grants You a world-wide, royalty-free, non-exclusive license </P>
<P>(a) under intellectual property rights (other than patent or trademark)
Licensable by Contributor, to use, reproduce, modify, display, perform,
sublicense and distribute the Modifications created by such Contributor (or
portions thereof) either on an unmodified basis, with other Modifications, as
Covered Code and/or as part of a Larger Work; and </P>
<P>(b) under Patent Claims infringed by the making, using, or selling of
Modifications made by that Contributor either alone and/or in combination with
its Contributor Version (or portions of such combination), to make, use, sell,
offer for sale, have made, and/or otherwise dispose of: 1) Modifications made
by that Contributor (or portions thereof); and 2) the combination of
Modifications made by that Contributor with its Contributor Version (or
portions of such combination). </P>
<P>(c) the licenses granted in Sections 2.2(a) and 2.2(b) are effective on the
date Contributor first makes Commercial Use of the Covered Code.</P>
<P>(d) Notwithstanding Section 2.2(b) above, no patent license is granted: 1)
...
by Covered Code in the absence of Modifications made by that Contributor.</P>
<P><B><I>3. Distribution Obligations. </I></B></P>
<P>3.1. <B><U>Application of License.</U></B> </P>
...
<P>3.2. <B><U>Availability of Source Code. </U></B></P>
...
<P>3.3. <B><U>Description of Modifications. </U></B></P>
...
<P>3.4. <B><U>Intellectual Property Matters</U></B></P>
...
Covered Code that new knowledge has been obtained. </P>
...
<P>Contributor represents that, except as disclosed pursuant to Section 3.4(a)
above, Contributor believes that Contributor's Modifications are Contributor's
original creation(s) and/or Contributor has sufficient rights to grant the
rights conveyed by this License.</P>
<P>3.5. <B><U>Required Notices.</U></B> </P>
<P>You must duplicate the notice in Exhibit A in each file of the Source Code.
...
<P>3.6. <B><U>Distribution of Executable Versions. </U></B></P>
...
<P><B><I>4. Inability to Comply Due to Statute or
Regulation. </I></B></P>
...
understand it.</P>
<P><B><I>5. Application of this License.</I></B></P>
<P>This License applies to code to which the Initial Developer has attached the
notice in Exhibit A and to related Covered Code.</P>
<P><B><I>6. Versions of the License. </I></B></P>
<P>6.1. <B><U>New Versions.</U></B> </P>
<P>Inprise Corporation (''Inprise'') may publish revised and/or new versions of
the License from time to time. Each version will be given a distinguishing
version number. </P>
<P>6.2. <B><U>Effect of New Versions.</U></B> </P>
...
License. </P>
<P>6.3. <B><U>Derivative Works.</U></B> </P>
<P>If You create or use a modified version of this License (which you may only
...
''NPL&quot;, &quot;InterBase&quot;, &quot;Inprise&quot;, &quot;Borland'' or any
...
shall not of themselves be deemed to be modifications of this License.)</P>
<P>6.4 <B><U>Origin of the InterBase Public License.</U></B></P>
<P>The InterBase public license is based on the Mozilla Public License V 1.1
with the following changes: </P>
<OL>
<LI>The license is published by Inprise Corporation. Only Inprise Corporation
can modify the terms applicable to Covered Code. </LI>
<LI>The license can be modified and used for code which is not already governed
by this license. Modified versions of the license must be renamed to avoid
confusion with Netscape&#146;s or Inprise&#146;s license and must include a
description of changes from the InterBase Public License.</LI>
<LI>The name of the license in Exhibit A is the &quot;InterBase Public
License&quot;. </LI>
<LI>The reference to an alternative license in Exhibit A has been removed.</LI>
<LI>Amendments I, II, III, V, and VI have been deleted.</LI>
<LI>Exhibit A, Netscape Public License has been deleted</LI>
<LI>A new amendment (II) has been added, describing the required and restricted
rights to use the trademarks of Inprise Corporation.</LI>
</OL>
<P><B><I>7. DISCLAIMER OF WARRANTY.</I></B></P>
...
<P>(a) such Participant's Contributor Version directly or indirectly infringes
...
terminate at the expiration of the 60 day notice period specified above. </P>
<P>(b) any software, hardware, or device, other than such Participant's
Contributor Version, directly or indirectly infringes any patent, then any
rights granted to You by such Participant under Sections 2.1(b) and 2.2(b) are
revoked effective as of the date You first made, used, sold, distributed, or
had made, Modifications made by that Participant. </P>
...
<P><B><I>9. LIMITATION OF LIABILITY.</I></B></P>
...
APPLY TO YOU.</P>
<P><B><I>10. U.S. GOVERNMENT END USERS. </I></B></P>
...
Georgia and/or the state courts of Gwinnett County, Georgia, with the losing
...
<P><B><I>12. RESPONSIBILITY FOR CLAIMS. </I></B></P>
...
<P><B><I>13. MULTIPLE-LICENSED CODE. </I></B></P>
...
Your choice of the InterBase Public License or the alternative licenses, if
any, specified by the Initial Developer in the file described in Exhibit A.</P>
<P><B><U>EXHIBIT A - InterBase Public
License.</U></B></P>
<P>``The contents of this file are subject to the InterBase Public License
Version 1.0 (the &quot;License&quot;); you may not use this file except in
compliance with the License. You may obtain a copy of the License at
http://www.interbase.com/IPL.html </P>
...
the License. </P>
<P>The Original Code was created by InterBase Software Corp and its successors.
</P>
<P>Portions created by Borland/Inprise are Copyright (C) Borland/Inprise. All
Rights Reserved. </P>
<P>Contributor(s): ______________________________________. </P>
<P><B><U>AMENDMENTS</U></B></P>
<P>I. InterBase and logo. This License does not grant any rights to use the
trademarks &quot;InterBase'', &quot;Java&quot; or &quot;JavaScript&quot; even
if such marks are included in the Original Code or Modifications. </P>
<P>II. Trademark Usage. </P>
<P>II.1. Advertising Materials. All advertising materials mentioning features
or use of the covered Code must display the following acknowledgement:
&quot;This product includes software developed by Inprise Corporation. &quot;
</P>
<P>II.2. Endorsements. The names &quot;InterBase,&quot; &quot;Inprise,&quot;
and &quot;Borland&quot; must not be used to endorse or promote Contributor
Versions or Larger Works without the prior written permission of InterBase.</P>
<P>II.3. Product Names. Contributor Versions and Larger Works may not be called
&quot;InterBase&quot; or &quot;InterBase&quot; nor may the word
&quot;InterBase&quot; appear in their names without the prior written
permission of Inprise.</P>
<p>
<hr>
<p>
