...
?>
<h4>Initial Developer's PUBLIC LICENSE Version 1.0</h4>
<TR>
<TD>
<P> 1. Definitions </P>
...
Modification is: </P>
<P> Any addition to or deletion from the contents of a file containing Original
...
<P><B>2.1. The Initial Developer Grant.</B> The Initial Developer hereby grants
You a world-wide, royalty-free, non-exclusive license, subject to third party
...
<P> (c) the licenses granted in this Section 2.1(a) and (b) are effective on
the date Initial Developer first distributes Original Code under the terms of
this License. </P>
<P> d) Notwithstanding Section 2.1(b) above, no patent license is granted:</P>
<P> 1) for code that You delete from the Original Code; </P>
<P> 2) separate from the Original Code; or </P>
<P> 3) for infringements caused by: </P>
<P> i) the modification of the Original Code or </P>
<P> ii) the combination of the Original Code with other software or devices. 
</P>
<P><B>2.2. Contributor Grant.</B> Subject to third party intellectual property
...
<P> (d) Notwithstanding Section 2.2(b) above, no patent license is granted: 
</P>
<P> 1) for any code that Contributor has deleted from the Contributor Version; 
</P>
<P> 2) separate from the Contributor Version; </P>
<P> 3) for infringements caused by: i) third party modifications of Contributor
Version or </P>
<P> ii) the combination of Modifications made by that Contributor with other
software (except as part of the Contributor Version) or other devices; or </P>
<P> 4) under Patent Claims infringed by Covered Code in the absence of
Modifications made by that Contributor. </P>
<P>3. Distribution Obligations. </P>
<P><B>3.1. Application of License.</B> The Modifications which You create or to
...
Section 3.5.</P>
<P><B>3.2. Availability of Source Code</B>. Any Modification which You create
...
by a third party. </P>
<P><B>3.3. Description of Modifications.</B> You must cause all Covered Code to
...
the Initial Developer in </P>
<P> (a) the Source Code, and </P>
<P> (b) in any notice in an Executable version or related documentation in
which You describe the origin or ownership of the Covered Code.</P>
...
<P>(b) Contributor APIs. If Contributor's Modifications include an application
...
this information in the LEGAL file. </P>
<P>(c) Representations. Contributor represents that, except as disclosed
...
<P><B>3.5. Required Notices.</B> You must duplicate the notice in Exhibit A in
...
offer. </P>
<P><B>3.6. Distribution of Executable Versions.</B> You may distribute Covered
...
are in compliance with the terms of this License and hat the license for the
...
terms You offer. </P>
<P><B>3.7. Larger Works.</B> You may create a Larger Work by combining Covered
...
or regulation then You must: </P>
<P> (a) comply with the terms of this License to the maximum extent possible;
and </P>
<P> (b) describe the limitations and the code they affect. Such description
...
<P><B>6.1. New Versions.</B> The Initial Developer of this code may publish
revised and/or new versions of the License from time to time. Each version will
be given a distinguishing version number. </P>
<P><B>6.2. Effect of New Versions.</B> Once Covered Code has been published
...
Initial Developer. No one other than the Initial Developer has the right to
modify the terms applicable to Covered Code created under this License. </P>
...
modifications of this License.) </P>
<P><B>6.4 Origin of the Initial Developer's Public License.</B> The Initial
Developer's Public License is based on the Mozilla Public License V 1.1 with
the following changes: </P>
<P> 1) The license is published by the Initial Developer of this code. Only the
...
Public License&quot;. </P>
<P>4) The reference to an alternative license in Exhibit A has been removed . 
</P>
...
notice You either: </P>
<P> (i) agree in writing to pay Participant a mutually agreeable reasonable
royalty for Your past and future use of Modifications made by such Participant,
or</P>
<P>(ii) withdraw Your litigation claim with respect to the Contributor Version
against such Participant. </P>
<P>If within 60 days of notice, a reasonable royalty and payment arrangement
are not mutually agreed upon in writing by the parties or the litigation claim
is not withdrawn, the rights granted by Participant to You under Sections 2.1
...
Initial Devpoeloper permits you to utilize portions of the Covered Code under
Your choice of the IDPL or the alternative licenses, if any, specified by the
Initial Developer in the file described in Exhibit A. </P>
<P> <B>EXHIBIT A</B> -Initial Developer's Public License. </P>
<P>The contents of this file are subject to the Initial Developer's Public
License Version 1.0 (the &quot;License&quot;); you may not use this file except
in compliance with the License. You may obtain a copy of the License from the Firebird 
Project website, at http://www.firebirdsql.org/index.php?op=doc&id=idpl.</p>
<p>
...
<P> Portions created by ______________________ <BR>
are Copyright (C) ______ _______________________. </P>
