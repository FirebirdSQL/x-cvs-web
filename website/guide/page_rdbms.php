...
<H4>What is Firebird&trade; RDBMS ?</H4>
As it's stands today, Firebird 1.0 is basically the InterBase&reg; 6.0 engine released by Borland with a lot of bug fixes and some improvements. So, if you want to know what Firebird can do for you, you have to look at InterBase 6.0 first...
...
InterBase&reg; was released by Borland under <A href="index.php?op=doc&amp;id=ipl">InterBase Public Licence</A>, a variant of <A href="http://www.mozilla.org/MPL/MPL-1.1.html">Mozilla Public Licence</A> (MPL).
<H5>About Firebird&trade;, the InterBase's successor</H5>
