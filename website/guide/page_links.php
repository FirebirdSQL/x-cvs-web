...
There are many great sites dedicated to InterBase® and Firebird out there, so it's hard to pick a few best places for novice's, but here it is:
<p>
...
<li><A HREF="http://nav.webring.org/cgi-bin/navcgi?ring=interbase;list">InterBase
WebRing</A><br>
Founded by Claudio Valderrama C., this webring is a hub for
sites providing assistance, information and tools to the InterBase developer.<P>
</ul>
...
<li><A HREF="http://www.interbase-br.com/">InterBase-BR</A><br>
