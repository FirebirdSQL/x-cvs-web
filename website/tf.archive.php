<?php
basename(__FILE__) == basename($PHP_SELF) ? die('<a href="http://lk.users.phpclasses.org/browse.html/package/945.html">tf.archive.php</a>, contains compressing functions for <a href="http://zone.ee/txtforum/">txtForum</a>. <h2><a href="forum.php">Local forum is here</a></h2>') : '';
