...
function ForumAdmin() {
    global $hlpfile, $admin, $bgcolor2, $bgcolor4, $textcolor2;
    include ("config.php");
    include ("header.php");
...
function ForumGo($cat_id,$ctg) {
    global $hlpfile, $admin, $bgcolor2, $textcolor2;
    include ("config.php");
    include ("header.php");
    GraphicAdmin($hlpfile);
    OpenTable4();
	...
	$userdata = mysql_query("select uname from users where uid='$forum_moderator'");
...
function ForumGoEdit($forum_id) {
    ...
    include ("header.php");
    GraphicAdmin($hlpfile);
    $result = mysql_query("select forum_id, forum_name, forum_desc, forum_access, forum_moderator, cat_id, forum_type from forums where forum_id='$forum_id'");
    ...
    <tr><td> ".translate("Moderator:")." </td>";
    $result = mysql_query("select uname from users where uid='$forum_mod'");
...
function ForumGoSave($forum_id, $forum_name, $forum_desc, $forum_access, $forum_mod, $cat_id, $forum_type, $forum_pass) {
    $result = mysql_query("select uid from users where uname='$forum_mod'");
	...
	mysql_query("update users_status set level='2' where uid='$forum_moderator'");    
	if (!$forum_pass) {
	    mysql_query("update forums set forum_name='$forum_name', forum_desc='$forum_desc', forum_access='$forum_access', forum_moderator='$forum_moderator', cat_id='$cat_id', forum_type='$forum_type', forum_pass='$forum_pass' where forum_id='$forum_id'");
	} else {
	    mysql_query("update forums set forum_name='$forum_name', forum_desc='$forum_desc', forum_access='$forum_access', forum_moderator='$forum_moderator', cat_id='$cat_id', forum_type='$forum_type' where forum_id='$forum_id'");
	}
	Header("Location: admin.php?op=ForumAdmin");
    }
}
...
function ForumCatAdd($catagories) {
    mysql_query("insert into catagories values (NULL, '$catagories')");
    Header("Location: admin.php?op=ForumAdmin");
}
...
function ForumGoAdd($forum_name, $forum_desc, $forum_access, $forum_mod, $cat_id, $forum_type, $forum_pass) {
	...
	mysql_query("update users_status set level='2' where uid='$forum_moderator'");
	mysql_query("insert into forums values (NULL, '$forum_name', '$forum_desc', '$forum_access', '$forum_moderator', '$cat_id', '$forum_type', '$forum_pass')");
