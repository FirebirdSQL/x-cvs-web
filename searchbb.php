...
$query = "SELECT u.uid,f.forum_id,p.topic_id, u.uname, p.post_time,t.topic_title,f.forum_name FROM posts p, users u, forums f,forumtopics t";
if(isset($term)&&$term!="")
{
...
{
	if(!$result = mysql_query("SELECT uid FROM users WHERE uname='$username'",$db))
	{
	    forumerror(0001);
	}
