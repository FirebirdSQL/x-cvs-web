...
if($submit) {
	...
	switch($mode) {
		case 'del':
			...
			if(!$result = mysql_query($sql, $db))
			echo translate("The topic has been removed from the database.")."<br><a href=\"viewforum.php?forum=$forum\">".translate("Click here to return to the forum.")."</a><br><a href=\"forum.php\">".translate("Click here to return to the forum index.")."</a>";
		break;
		case 'move':
			...
			if(!$r = mysql_query($sql, $db))
			    forumerror(0010);
			echo translate("The topic has been moved.")."<br><a href=\"viewtopic.php?topic=$topic&forum=$newforum\">".translate("Click here to view the updated topic.")."</a><br><a href=\"forum.php\">".translate("Click here to return to the forum index.")."</a>";
		break;
		case 'lock':
			$sql = "UPDATE forumtopics SET topic_status = 1 WHERE topic_id = '$topic'";
			if(!$r = mysql_query($sql, $db))
			    forumerror(0011);
			echo translate("The topic has been locked.")."<br><a href=\"viewtopic.php?topic=$topic&forum=$forum\">".translate("Click here to view the updated topic.")."</a><br><a href=\"forum.php\">".translate("Click here to return to the forum index.")."</a>";
		break;
		case 'unlock':
			$sql = "UPDATE forumtopics SET topic_status = '0' WHERE topic_id = '$topic'";
			if(!$r = mysql_query($sql, $db))
			    forumerror(0012);
			echo translate("The topic has been unlocked.")."<br><a href=\"viewtopic.php?topic=$topic&forum=$forum\">".translate("Click here to view the updated topic.")."</a><br><a href=\"forum.php\">".translate("Click here to return to the forum index.")."</a>";
		break;
		case 'viewip':
			$sql = "SELECT u.uname, p.poster_ip FROM users u, posts p WHERE p.post_id = '$post' AND u.uid = p.poster_id";
			if(!$r = mysql_query($sql, $db))
			    forumerror(0013);
